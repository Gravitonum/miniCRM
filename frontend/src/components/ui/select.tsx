 ...
 *   <SelectContent>
 *     <SelectItem value="prospecting">Поиск</SelectItem>
 *   </SelectContent>
 * </Select>
 */
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex h-11 w-full items-center justify-between rounded-xl border-2 border-border bg-muted/40 px-4 py-2 text-sm',
            'ring-offset-background placeholder:text-muted-foreground',
            'focus:outline-none focus:ring-4 focus:ring-ring/20 focus:border-primary',
