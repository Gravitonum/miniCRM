...
**🎯 Задача:**
Создай современное SPA-приложение с:
1. Страницей регистрации и входа (формы с валидацией)
2. Автоматическим обновлением токенов (перед истечением срока)
3. CRUD интерфейсами для всех таблиц проекта (списки, формы создания/редактирования)
4. Навигацией между разделами (sidebar или header menu)
5. Обработкой ошибок API и loading состояний
6. Адаптивным дизайном (mobile-friendly)
7. Logout функционалом

**💡 Технические рекомендации:**
- Stack: React + TypeScript + Ant Design (или Material-UI)
- Axios interceptors для автоматической подстановки токена и обновления при 401
- React Router v6 для навигации
- React Query или SWR для кэширования и управления состоянием сервера
- Переиспользуемые компоненты: DataTable, Form, Layout
- Error boundaries для обработки ошибок React
...
Создай production-ready приложение с чистым кодом и best practices!